                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/analyze" className="text-gray-400 hover:text-pink-400 transition-colors">
                                    {t('nav.analyze')}
                                </Link>
                            </li>
                            <li>
                                <Link to="/knowledge" className="text-gray-400 hover:text-pink-400 transition-colors">
                                    {t('nav.knowledge')}
                                </Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li className="flex items-center gap-2">
                                ...
                                <span>hoangle120105@gmail.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
